...
{
    public class InterfaceProxyGeneratorFixture_General
    {
        ...
        public class Foobar : IFoobar
        {
            ...
            public async Task<int> InvokeAsTaskOfResult(int x, int y)
            {
                Invoked = true;
                await Task.Delay(10);
                return x + y;
            ...
            public async ValueTask InvokeAsValueTask(int x, int y)
            {
                Invoked = true;
                await Task.Delay(10);
            }

            public async ValueTask<int> InvokeAsValueTaskOfResult(int x, int y)
            {
                Invoked = true;
                await Task.Delay(10);
                return x + y;
