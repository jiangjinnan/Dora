...
namespace Dora.ExceptionHandling.Configuration.Properties
{
    ...
    internal class Resources
    {
        ...
        /// <summary>
        /// The filter configuration type is not specified by applying the FilterConfigurationAttribute to the class "{0}".
        /// </summary>
        internal static string ExceptionFilterConfigurationTypeNotSet
        {
            get
            {
                return ResourceManager.GetString("ExceptionFilterConfigurationTypeNotSet", resourceCulture);
            }
        }
