...
//{
//    /// <summary>
//    /// Default implementation of OAuth based request context factory.
//    /// </summary>
//    public class OAuthRequestContextFactory : IOAuthContextFactory
//    {
//        #region Fields
...
//        private readonly ISecureDataFormat<OAuthTicket> _oauthTockeFormat;
//        #endregion
...
//        public OAuthRequestContextFactory(ISecureDataFormat<OAuthTicket> oauthTockeFormat, IEnumerable<string> defaultScope)
//        {
//            _oauthTockeFormat = Guard.ArgumentNotNull(oauthTockeFormat, nameof(oauthTockeFormat));

//            _validResponseTypes = new string[] { "code", "token" };
//            _valideGrantTypes = new string[] { "authorization_code", "refresh_token" };
//            _defaultScope = Guard.ArgumentNotNullOrEmpty(defaultScope, nameof(defaultScope)).Select(it => it.ToLowerInvariant()).ToArray();
//        }
...
//        public Task<ResourceContext> CreateResourceContextAsync(HttpContext httpContext)
//        {
...
//                try
//                {
//                    OAuthTicket authorizationCode = _oauthTockeFormat.Unprotect(code);
...
//                try
//                {
//                    OAuthTicket refreshToken = _oauthTockeFormat.Unprotect(token);
