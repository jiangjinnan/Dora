...
namespace Microsoft.Extensions.DependencyInjection.ServiceLookup
{
    internal class ILEmitServiceProviderEngine : ServiceProviderEngine
    {
        ...
        public ILEmitServiceProviderEngine(IEnumerable<ServiceDescriptor> serviceDescriptors, IServiceProviderEngineCallback callback, IInterceptingProxyFactory proxyFactory) : base(serviceDescriptors, callback, proxyFactory)
        {
