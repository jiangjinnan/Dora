...
namespace Microsoft.Extensions.DependencyInjection.ServiceLookup
{
    internal class ServiceTable
    {
        ...
        public ServiceTable(IEnumerable<ServiceDescriptor> descriptors, IProxyFactory proxyFactory)
        {
            ...
            foreach (var descriptor in descriptors)
            {
                ...
                if (serviceTypeInfo.IsGenericTypeDefinition)
                {
                        ...
                        !implementationTypeInfo.IsGenericTypeDefinition)
                    {
                        throw new ArgumentException(
                            Resources.OpenGenericServiceRequiresOpenGenericImplementation.Fill(
                    ...
                    {
                        throw new ArgumentException(
                            Resources.TypeCannotBeActivated.Fill(
                ...
                else
                {
                    ...
                    Add(descriptor.ServiceType, new InterceptService(descriptor, _proxyFactory));
                }
            }
        }
