...
namespace Microsoft.Extensions.DependencyInjection.ServiceLookup
{
    internal class Service : IService
    {
        ...
        public virtual IServiceCallSite CreateCallSite(ServiceProvider provider, ISet<Type> callSiteChain)
        {
            ...
            {
                throw new InvalidOperationException(Resources.NoConstructorMatch.Fill(_descriptor.ImplementationType));
            }
                    ...
                    else
                    {
                        ...
                        if (!bestConstructorParameterTypes.IsSupersetOf(parameters.Select(p => p.ParameterType)))
                        {
                            ...
                            var message = string.Join(
                                Environment.NewLine,
                                Resources.AmbigiousConstructorException.Fill(_descriptor.ImplementationType),
                                bestConstructor,
                                constructors[i]);
            ...
            if (bestConstructor == null)
            {
                throw new InvalidOperationException(
                    Resources.UnableToActivateTypeException.Fill(_descriptor.ImplementationType));
            }
            else
            {
            ...
            bool throwIfCallSiteNotFound)
        {
            ...
            for (var index = 0; index < parameters.Length; index++)
            {
                ...
                if (callSite == null)
                {
                    ...
                    {
                        throw new InvalidOperationException(Resources.CannotResolveService .Fill(
